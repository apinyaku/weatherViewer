(function ($) {
    ...
    genRandomFontInLinks = function (controlName) {
        /*Colors to add for anchor tags*/
        var colors = ['red', 'green', 'blue', 'orange', 'white'];
        ...
        $(controlName).find('a').each(function (e) {
            /*Applying font size*/
